...
public class MainActivity extends Activity {
	...
	private final static String MY_DEBUG_BT = "98:D3:31:80:47:2D";  //调试用蓝牙MAC地址
//	private final static String ROBOT_BT = "98:D3:33:80:7E:92";  //机器人蓝牙MAC地址
...
//	        	showTip(action);
	        	isConnectBT = false;
	        	handler.postDelayed(runnable, 3000);
	        	mTts.startSpeaking("蓝牙已断开，正在尝试重新连接", mTtsListener);
	        }
	...
	private void connectBT(){
		...
		// 得到蓝牙设备句柄      
        _device = _bluetooth.getRemoteDevice(MY_DEBUG_BT);
...
//        	Toast.makeText(this, "连接"+_device.getName()+"成功！", Toast.LENGTH_SHORT).show();
        	...
        	try{
        		isConnectBT = false;
//        		Toast.makeText(this, "连接失败！", Toast.LENGTH_SHORT).show();
        		mTts.startSpeaking("蓝牙连接失败，请确认设备状态", mTtsListener);
        		_socket.close();
        		_socket = null;
